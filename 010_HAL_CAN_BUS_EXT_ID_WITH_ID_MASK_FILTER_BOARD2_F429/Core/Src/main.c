...
// Set pHeader Parameters
  ...
  pTxHeader.ExtId = 0x1FBF4000;   /*!< Specifies the extended identifier. This parameter must be
  	  	  	  	  	  	  	  	  	  a number between Min_Data = 0 and Max_Data = 0x1FFFFFFF. */

      // ExtId =  0x1FBF8999 ,0x1FBF9000 ,0x1FBFA000 use!
  	  // 0x1AB03FFF , 0x1AB04000 , 0x1AB04FFF, 0x1AB05999  use!
...
// Set Filter Parameters  // ***** EXT ID  MASK Filtre ile birden fazla aralıktaki mesajları alma uygulamasi:
