...
// Set pHeader Parameters
  ...
  /* Board1 :
     * sFilterConfig.FilterIdHigh = 0x1FFF9000 >> 13;
     * sFilterConfig.FilterMaskIdHigh = 0xFFFFF000 >> 13;
     * Filtre :  0x1FFF9000 --  0x1FFF9FFF
     */
    // **High degeri girdik ama low girilmedigi için  0x1FFF9000 degerinin altındaki id'lerden mesaj gelir.**

  // Alınan veriyi  CAN1_RX0_IRQHandler(void) ile alıcagız. Ayrıntılar -> stm32f4xx_it.c

// Set Filter Parameters // ***** TEK EXT MASK ID Filtre maskeleme ile belirli aralıktaki mesajları alma uygulamasi:
  ...
  sFilterConfig.FilterIdHigh = 0x1FBF9000 >> 13;  //  0x1FFF9000 --  0x1FFF9FFF
