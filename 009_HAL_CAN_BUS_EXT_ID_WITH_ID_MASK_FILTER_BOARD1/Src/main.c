...
/**
  ...
  * @attention
  ***********************************************************************************************
  ***** 2 EXT ID MASK FİLTRE KULLANIMI VE BELİRLİ BİR ARALIKTAKİ IDLERDEN MESAJ ALIMI  **********
  ***********************************************************************************************
  ***********************************************************************************************
  */
...
// Set pHeader Parameters
  ...
  // **High ve Low girildigi  için  0x1FFF9000 degerinin altındaki id'lerden mesaj gelmez.**


  // Alınan veriyi  CAN1_RX0_IRQHandler(void) ile alıcagız. Ayrıntılar -> stm32f4xx_it.c

// Set Filter Parameters // ** EXT MASK ID Filtre maskeleme ile belirli aralıktaki mesajları alma uygulamasi:
