...
// Set pHeader Parameters
  ...
  pTxHeader.ExtId =  0x1FBF9FFF;   /*!< Specifies the extended identifier. This parameter must be
  	  	  	  	  	  	  	  	  	  a number between Min_Data = 0 and Max_Data = 0x1FFFFFFF. */

  // 0x1FBF9500 , 0x1FBFA500 , 0x1FBF8000 ,0x1FBF7FFF  ... use!
...
// Set Filter Parameters
  // ***** TEK EXT MASK ID Filtre maskeleme ile belirli aralıktaki mesajları alma uygulamasi:
