...
// Set pHeader Parameters
  ...
  pTxHeader.ExtId = 0x1FBF9000;   /*!< Specifies the extended identifier. This parameter must be
  	  	  	  	  	  	  	  	  	  a number between Min_Data = 0 and Max_Data = 0x1FFFFFFF. */

      // ExtId = 0x1FBF9000 , 0x1FBF9001 , 0x1AB03000 ,  0x1AB03001, use!
...
// Set Filter Parameters
  ...
  sFilterConfig.FilterMaskIdLow  =  0x0000;    // filtreleme yapmadık...
